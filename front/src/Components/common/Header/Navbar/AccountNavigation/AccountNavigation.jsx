...
export const AccountNavigation = props => {
    ...
    const avatar = useSelector(state => state.app.authorizedUser.avatar)
    const authorizedUserUsername = useSelector(state => state.app.authorizedUser.username)
    return (
        <div className={styles.avatar}
            ...
            <img src={avatar ? avatar : NoAvatarIcon} alt="" />
            <div className={styles.dropDownMenuWrapper} style={style}>
                <NavLink to={`/profile/${authorizedUserUsername}`}>
                    <div className={classNames(styles.dropDownMenuItem, styles.accountNav)} >
                ...
                <div onClick={() => dispatch(logOut())}
                    className={classNames(styles.dropDownMenuItem, styles.logOutBtn)}>
                    Log Out</div>
            </div>
        </div >
    )
